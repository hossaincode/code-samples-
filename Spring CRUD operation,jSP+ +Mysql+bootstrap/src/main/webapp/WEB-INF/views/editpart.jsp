...
<h2 class="text-center" ><i class="fas fa-tools"></i> Edit Products Details</h2>
<form:form method="POST" modelAttribute="parts2" class="form-horizontal">
	...
	<div class="row">
		...
		<input class="col-md-12" type="submit"  class="btn btn-primary" value="Update">
